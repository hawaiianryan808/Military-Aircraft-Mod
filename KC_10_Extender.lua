...
KC_10_Extender =  {
	...
	--Categories= {"{8A302789-A55D-4897-B647-66493FA6826F}", "",},
		...
		refueling_points = 
		{
			...
			--            +   -      +  -      -    +
			-- [1] = { pos = {-34.096, -11.485, 0.000}, clientType = 3 },--BOOM
			[1] = { pos = {-34.096214, -11.485015, 0.000052}, clientType = 3 },--BOOM
			
			-- [1] = { pos = {-29.029   ,-7.65      ,0.0      }, clientType = 3 },	--BOOM
            -- [2] = { pos = {-35.863   ,-5.176     , 0.964   }, clientType = 3 },--Drogue	
